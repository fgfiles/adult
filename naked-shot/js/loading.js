...
function setLoading(active) {
    ...
    ObjAnimate('spr_interface_loading_sex', 'alp', 0, 0, function() { }, [ 0,0,'cur', 0.5,0,active ]);
    var pseudoPercentLoadingSexScene = 100;
    if (active) {
        pseudoPercentLoadingSexScene = 0;
    }
    ObjSet('spr_interface_loading_download_sex_line', { width: pseudoPercentLoadingSexScene * 2 });
    ObjSet('spr_interface_loading_download_sex_text', { text: 'Loaded ' + pseudoPercentLoadingSexScene + '%' });
}

function setLoadingDownloadScene(active) {
    ObjSet('spr_interface_loading_download_scene', { input: active });
    ObjAnimate('spr_interface_loading_download_scene', 'alp', 0, 0, function() { }, [ 0,0,'cur', 0.5,0,active ]);
...
function setPercent() {
    ...
    if (isNumber(percent) && percent >= 0 && percent <= 1) {
        ...
        ObjSet('spr_interface_loading_download_scene_line', { width: viewPercent * 2 });
